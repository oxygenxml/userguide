...
-->
  ...
  <sch:pattern>
    ...
    <sch:rule context="*[contains(@class, ' topic/ol ')]">
      <sch:report test="not(@product or following-sibling::node()[1]/@product or following-sibling::node()[1][self::text() and normalize-space(.)='']/following-sibling::node()[1]/@product) and
