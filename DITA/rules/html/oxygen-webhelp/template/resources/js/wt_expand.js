...
var selectors = {
    /* Selectors for the nodes that will act as expand/collapse buttons. */
    "expand_buttons" : [
        /* Table caption */
        "table > caption",
        /* Article title */
...
$(document).ready(function () {
	/* Mark the expand/collapse buttons. */
    selectors.expand_buttons.forEach(
        function(selector) {
            var matchedNodes =  $(document).find(selector);
            matchedNodes.addClass("wh_expand_btn expanded");
    ...
    $(document).find('.wh_expand_btn').click(function(event){
        ...
        // Do not expand-collapse the marked nodes.
        var siblings = $(this).siblings(':not(.wh_not_expandable)');
