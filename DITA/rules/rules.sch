...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
  ...
  <sch:pattern>
    <sch:rule context="*[contains(@class, ' topic/title ')and not(parent::node()/contains(@class, ' topic/section ')) and not(parent::node()/contains(@class, ' topic/fig ')) and not(parent::node()/contains(@class, ' topic/table '))]" role="warn">
